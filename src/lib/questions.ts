...
export const PROFESSIONAL_QUESTIONS: Question[] = [
  ...
  { id: 'v1', examType: 'professional', section: 'verbal', questionText: 'Choose the word that best completes the sentence: The manager\'s _____ approach helped resolve the conflict quickly.', choices: ['diplomatic', 'aggressive', 'indifferent', 'hostile'], correctAnswer: 'diplomatic' },
  ...
  { id: 'v3', examType: 'professional', section: 'verbal', questionText: 'Identify the correct sentence:', choices: ['Each of the students have submitted their reports.', 'Each of the students has submitted their report.', 'Each of the students have submitted his report.', 'Each of the students has submitted his or her report.'], correctAnswer: 'Each of the students has submitted his or her report.' },
  { id: 'v4', examType: 'professional', section: 'verbal', questionText: 'What is the meaning of the word "ubiquitous"?', choices: ['Rare', 'Present everywhere', 'Hidden', 'Ancient'], correctAnswer: 'Present everywhere' },
  ...
  { id: 'n1', examType: 'professional', section: 'numerical', questionText: 'If a product costs ₱450 and is sold at a 20% profit, what is the selling price?', choices: ['₱540', '₱520', '₱500', '₱560'], correctAnswer: '₱540' },
  { id: 'n2', examType: 'professional', section: 'numerical', questionText: 'A worker can complete a task in 6 hours. Another worker can do it in 4 hours. How long working together?', choices: ['2 hours', '2.4 hours', '3 hours', '5 hours'], correctAnswer: '2.4 hours' },
  { id: 'n3', examType: 'professional', section: 'numerical', questionText: 'What is 15% of 840?', choices: ['126', '124', '128', '130'], correctAnswer: '126' },
  { id: 'n4', examType: 'professional', section: 'numerical', questionText: 'If 3x + 7 = 22, what is the value of x?', choices: ['5', '6', '7', '8'], correctAnswer: '5' },
  { id: 'n5', examType: 'professional', section: 'numerical', questionText: 'A train travels 240 km in 3 hours. What is its average speed?', choices: ['70 km/h', '75 km/h', '80 km/h', '85 km/h'], correctAnswer: '80 km/h' },
  ...
  { id: 'a1', examType: 'professional', section: 'analytical', questionText: 'All managers are leaders. Some leaders are visionaries. Which statement MUST be true?', choices: ['All managers are visionaries', 'Some managers may be visionaries', 'No managers are visionaries', 'All visionaries are managers'], correctAnswer: 'Some managers may be visionaries' },
  { id: 'a2', examType: 'professional', section: 'analytical', questionText: 'If APPLE is coded as ELPPA, how is MANGO coded?', choices: ['OGNAM', 'GNAMO', 'OGANM', 'MANOG'], correctAnswer: 'OGNAM' },
  { id: 'a3', examType: 'professional', section: 'analytical', questionText: 'Complete the series: 2, 6, 12, 20, 30, ?', choices: ['40', '42', '44', '46'], correctAnswer: '42' },
  { id: 'a4', examType: 'professional', section: 'analytical', questionText: 'If A > B, B > C, and C > D, which is definitely true?', choices: ['D > A', 'A > D', 'B > D only', 'Cannot be determined'], correctAnswer: 'A > D' },
  ...
  { id: 'a7', examType: 'professional', section: 'analytical', questionText: 'Complete: 1, 4, 9, 16, 25, ?', choices: ['30', '36', '49', '64'], correctAnswer: '36' },
  { id: 'a8', examType: 'professional', section: 'analytical', questionText: 'All cats are mammals. All mammals are animals. Therefore:', choices: ['All animals are cats', 'All cats are animals', 'Some animals are cats', 'No cats are animals'], correctAnswer: 'All cats are animals' },
  ...
  { id: 'g1', examType: 'professional', section: 'general', questionText: 'What is Republic Act No. 6713 also known as?', choices: ['Anti-Graft and Corrupt Practices Act', 'Code of Conduct and Ethical Standards for Public Officials and Employees', 'Administrative Code of 1987', 'Civil Service Law'], correctAnswer: 'Code of Conduct and Ethical Standards for Public Officials and Employees' },
  { id: 'g2', examType: 'professional', section: 'general', questionText: 'How many articles are in the 1987 Philippine Constitution?', choices: ['15', '16', '17', '18'], correctAnswer: '18' },
  { id: 'g3', examType: 'professional', section: 'general', questionText: 'Which is NOT a branch of the Philippine government?', choices: ['Executive', 'Legislative', 'Judiciary', 'Administrative'], correctAnswer: 'Administrative' },
  { id: 'g4', examType: 'professional', section: 'general', questionText: 'What does CSC stand for?', choices: ['Civil Service Center', 'Civil Service Commission', 'Central Service Commission', 'Civil Servants Council'], correctAnswer: 'Civil Service Commission' },
